...
export interface GetBackgroundsParams {
  forDarkTheme?: boolean // True, if the backgrounds need to be ordered for dark theme
}

/**
 * Returns backgrounds installed by the user
 * @param {Object} params
 * @param {boolean} [params.forDarkTheme] - True, if the backgrounds need to be ordered
 * for dark theme
