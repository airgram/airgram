...
export interface GetTrendingStickerSetsParams {
  ...
  limit?: number // The maximum number of sticker sets to be returned; must be non-negative. For optimal performance, the number of returned sticker sets is chosen by TDLib and can be smaller than the specified limit, even if the end of the list has not been reached
}
 ...
 * must be non-negative. For optimal performance, the number of returned sticker sets
 * is chosen by TDLib and can be smaller than the specified limit, even if the end of
