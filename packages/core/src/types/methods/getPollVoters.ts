 ...
 * be positive and can't be greater than 50. For optimal performance, the number of
 * returned users is chosen by TDLib and can be smaller than the specified limit, even
