 ...
 * messages to search; pass null to search for all messages. Filters searchMessagesFilterCall,
 * searchMessagesFilterMissedCall, searchMessagesFilterMention, searchMessagesFilterUnreadMention,
