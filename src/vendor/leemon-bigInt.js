...
// leading zero element. Functions with an underscore at the end of the name updates
...
//and updates it into ans.  The bigInt ans must be large enough to hold it.
